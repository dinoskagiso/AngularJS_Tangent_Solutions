...
Ability to call a web service (userservice and projectservice) as described below
Ability to build a login with authentication
Ability to perform basic listing and viewing of the data using project service.
Summary
...
AngularJS v1: Superheroic JavaScript MVW Framework
Twitter Bootstrap v3: HTML, CSS, and JS framework for developing responsive, mobile first projects on the web
Font Awesome: The iconic font and CSS toolkit
Gulp: Streaming build system and task runner
Bower: A package manager for the web (client-side)
